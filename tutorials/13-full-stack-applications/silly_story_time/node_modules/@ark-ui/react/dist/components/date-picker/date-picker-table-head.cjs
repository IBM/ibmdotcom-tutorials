...
const DatePickerTableHead = react.forwardRef((props, ref) => {
  ...
  const mergedProps = react$1.mergeProps(datePicker.getTableHeadProps(tableProps), props);
  return /* @__PURE__ */ jsxRuntime.jsx(factory.ark.thead, { ...mergedProps, ref });
});
