...
This tutorial can be found inside the [tutorials directory of the repo](https://github.com/IBM/ibmdotcom-tutorials/tree/main/tutorials/03-multi-agent-systems/acp_tutorial).
